...
export default async function HomePage() {
  ...
  return (
    <article>
      ...
      <PageSummary>
        <p>
          ナムコの名作『ワルキューレの伝説』をモチーフにしたBGMが響き渡る隠しダンジョン「きらめきの塔」の攻略情報ページです。飛行艇によるアクセス方法や、各フロアを悩ませる難解な仕掛けの数々、最強武器に関わるワルキューレとのタイマン勝負のコツ、入手できる強力な装備やアイテムのデータを徹底解説します。
        </p>
      </PageSummary>
      ...
      <section className="mb-12">
        ...
        <div className="mb-4">
          ...
          <p>
            なお、ワルキューレを撃破したあとに一度きらめきの塔の外部や別のフロアへ出ると、それ以降はこのダンジョン内で通常のモンスターエンカウントが発生するようになります（帰りは敵が出現するので注意しましょう）。
          </p>
        </div>
        <div className="mb-4">
