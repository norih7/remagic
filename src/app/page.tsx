...
export async function generateMetadata() {
  return {
    title,
    description:
      "テイルズオブエターニア（TOE）リマスター版対応の攻略サイト。序盤から終盤までのストーリー攻略、晶霊術・特技一覧、装備品やアイテムのデータ、レンズの入手場所、隠しダンジョンや闘技場の攻略情報まで画像付きで詳しく解説しています。スマホでも読みやすいシンプルな設計で、初めての方にもわかりやすくまとめています。",
    alternates: {
      canonical: "/",
    },
  };
