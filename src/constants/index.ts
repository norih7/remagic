...
export const storyLinks: Record<string, PageLink> = {
  ...
  guide5: {
    title: "セイファート神殿〜シゼル城",
    path: "/stories/guide5",
    image: "/link-headers/stories-guide5.jpg",
    desc: "エンディングまでガイド。シゼル城のダンジョンをマップやゲーム画像を添えて徹底攻略！ラストバトルの解説も。",
    seoDesc:
      "リマスター版に対応したテイルズオブエターニア（TOE）の攻略ガイド。ストーリーエンディングまでを紹介。難しいシゼル城をマップやゲーム画像を添えて徹底攻略しています！",
  },
};
...
export const extraLinks: Record<string, PageLink> = {
  ...
  valkyrie: {
    ...
    image: "/link-headers/extras-valkyrie.jpg",
    desc: "きらめきの塔の徹底解説。謎解きの最短ルートの紹介や便利なメモ取りなど攻略をサポートします！",
    seoDesc:
  ...
  nereid: {
    title: "ネレイドの迷宮",
    path: "/extras/nereid",
    image: "/link-headers/extras-nereid.jpg",
